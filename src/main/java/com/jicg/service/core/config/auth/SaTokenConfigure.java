...
/**
 * @author jicg on 2021/5/10
 */

@Configuration
public class SaTokenConfigure implements WebMvcConfigurer {
    final AppProperties.AuthConfig authConfig;
    final AppProperties.IpFilter ipFilter;

    public SaTokenConfigure(AppProperties.AuthConfig authConfig, AppProperties.IpFilter ipFilter) {
